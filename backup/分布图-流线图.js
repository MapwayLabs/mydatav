...
// 这句必须加，不然会叠在一起
data0 = d3.layout.stack().offset('silhouette')(chartData0);
var tags;
...
var graph = d3.select("#custom-chart")
  .append("svg")
  .attr("width", w)
  .attr("height", h);
