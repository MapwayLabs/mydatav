...
//   scripts: 'https://cdnjs.cloudflare.com/ajax/libs/echarts/4.6.0/echarts.min.js',
  ...
  code: `
     importScript('/backup/动态图lib/echarts-3.7.0.js', initFunc, 'echarts');
     function initFunc() {
...
//   scripts: 'https://cdnjs.cloudflare.com/ajax/libs/echarts/4.6.0/echarts.min.js',
  ...
  code: `
    importScript('/backup/动态图lib/echarts-all-3.6.0.js', initFunc, 'echarts');
    function initFunc() {
        echarts.dispose(customEle);
        var myChart = echarts.init(customEle);
        // 指定图表的配置项和数据
...
}, 
{
    ...
    code: `
       importScript('/backup/分布图lib/echarts-3.8.4.js', initFunc, 'echarts');
       function initFunc(){
        echarts.dispose(customEle);
        var myChart = echarts.init(customEle);
        // 指定图表的配置项和数据
