...
function Edge(t, n, r) {
    ...
    this.target = n;
    this.name = "";
    this.alpha = r && r.alpha ? r.alpha : 0.6;
    this.properties = {};
    this.color = new THREE.Color(r && r.color ? r.color : '#1F3D7A');
	...
	updateNodeSizeByProperty: function(e, t) {
        if ("" == t)
            this.nodes.filter(function(t) {
                ...
                return e.size = global.currentNodesSize ? global.currentNodesSize : 1.585
            });
        else {
            ...
            if (r.length < 2)
                ...
                n.forEach(function(e) {
                    ...
                    r = o,
                    i = a,
                    global.currentNodesSize ? (1 + (n - i) / (r - i) * 3) * global.currentNodesSize : 1 * (1 + (n - i) / (r - i) * 3)))
                })
            }
        }
	},
